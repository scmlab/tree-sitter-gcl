...
enum {
  ...
  sym_constant = 92,
  sym_boolean = 93,
  sym__variable_list = 94,
  sym__constant_list = 95,
  sym__expr_list = 96,
  sym_guarded_command = 97,
  sym__guarded_command_list = 98,
  aux_sym_source_file_repeat1 = 99,
  aux_sym_source_file_repeat2 = 100,
  aux_sym__variable_list_repeat1 = 101,
  aux_sym__constant_list_repeat1 = 102,
  aux_sym__expr_list_repeat1 = 103,
  aux_sym__guarded_command_list_repeat1 = 104,
};
...
static uint16_t ts_parse_table[STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym_assert_with_bound] = STATE(179),
    [sym_if] = STATE(179),
    [sym_do] = STATE(179),
    [sym_spec] = STATE(179),
    ...
    [aux_sym__variable_list_repeat1] = STATE(132),
  ...
  [18] = {
    ...
    [aux_sym_type_token1] = ACTIONS(145),
  ...
  [50] = {
    ...
    [sym_guarded_command] = STATE(148),
    [sym__guarded_command_list] = STATE(180),
  ...
  [51] = {
    ...
    [sym_guarded_command] = STATE(148),
    [sym__guarded_command_list] = STATE(164),
  ...
  [59] = {
    ...
    [aux_sym__expr_list_repeat1] = STATE(59),
  ...
  [100] = {
    ...
    [anon_sym_LBRACE_BANG] = ACTIONS(337),
    [anon_sym_BANG_RBRACE] = ACTIONS(340),
  ...
  [102] = {
    ...
    [aux_sym_source_file_repeat2] = STATE(101),
    [aux_sym__variable_list_repeat1] = STATE(132),
    [sym_skip] = ACTIONS(350),
    [sym_abort] = ACTIONS(350),
    [anon_sym_LBRACE] = ACTIONS(13),
    [anon_sym_if] = ACTIONS(15),
    [anon_sym_do] = ACTIONS(17),
  ...
  [104] = {
    ...
    [anon_sym_do] = ACTIONS(17),
    [anon_sym_LBRACE_BANG] = ACTIONS(19),
    [anon_sym_BANG_RBRACE] = ACTIONS(357),
    [aux_sym_variable_token1] = ACTIONS(21),
    [sym_comment] = ACTIONS(3),
  },
  [105] = {
  ...
  [106] = {
    ...
    [anon_sym_do] = ACTIONS(17),
    [anon_sym_LBRACE_BANG] = ACTIONS(19),
    [anon_sym_BANG_RBRACE] = ACTIONS(359),
    [aux_sym_variable_token1] = ACTIONS(21),
    [sym_comment] = ACTIONS(3),
  },
  [107] = {
    ...
    [sym_skip] = ACTIONS(361),
    [sym_abort] = ACTIONS(361),
    [anon_sym_LBRACE] = ACTIONS(328),
    [anon_sym_if] = ACTIONS(331),
    [anon_sym_do] = ACTIONS(334),
    [anon_sym_LBRACE_BANG] = ACTIONS(337),
  ...
  [122] = {
    [sym__type] = STATE(134),
    [sym_type_func] = STATE(134),
    [sym_type_array] = STATE(134),
    [sym_type] = STATE(134),
    [sym__type_term] = STATE(134),
    [anon_sym_LPAREN] = ACTIONS(384),
    [anon_sym_array] = ACTIONS(386),
    [aux_sym_type_token1] = ACTIONS(388),
    [sym_comment] = ACTIONS(3),
  ...
  [123] = {
    [sym__type] = STATE(138),
    [sym_type_func] = STATE(138),
    [sym_type_array] = STATE(138),
    [sym_type] = STATE(138),
    [sym__type_term] = STATE(138),
    [anon_sym_LPAREN] = ACTIONS(384),
    [anon_sym_array] = ACTIONS(386),
    [aux_sym_type_token1] = ACTIONS(388),
    [sym_comment] = ACTIONS(3),
  ...
  [125] = {
    [sym__type] = STATE(149),
    [sym_type_func] = STATE(149),
    [sym_type_array] = STATE(149),
    [sym_type] = STATE(149),
    [sym__type_term] = STATE(149),
    [anon_sym_LPAREN] = ACTIONS(390),
    [anon_sym_array] = ACTIONS(392),
    [aux_sym_type_token1] = ACTIONS(394),
    [sym_comment] = ACTIONS(3),
  ...
  [132] = {
    ...
    [aux_sym__variable_list_repeat1] = STATE(137),
    [aux_sym_variable_token1] = ACTIONS(43),
    [sym_comment] = ACTIONS(3),
  },
  [133] = {
  ...
  [136] = {
    ...
    [aux_sym__constant_list_repeat1] = STATE(144),
    [aux_sym_type_token1] = ACTIONS(404),
    [sym_comment] = ACTIONS(3),
  },
  [137] = {
  ...
  [144] = {
    ...
    [aux_sym__constant_list_repeat1] = STATE(144),
    [aux_sym_type_token1] = ACTIONS(437),
    [sym_comment] = ACTIONS(3),
  },
  [145] = {
    [anon_sym_DASH_GT] = ACTIONS(423),
  ...
  [178] = {
    [aux_sym_type_token1] = ACTIONS(496),
    [sym_comment] = ACTIONS(3),
  },
  [179] = {
    [sym_comment] = ACTIONS(3),
...
static TSParseActionEntry ts_parse_actions[] = {
  ...
  [7] = {.count = 1, .reusable = false}, SHIFT(129),
  [9] = {.count = 1, .reusable = false}, SHIFT(130),
  [11] = {.count = 1, .reusable = false}, SHIFT(179),
  [13] = {.count = 1, .reusable = false}, SHIFT(87),
  [15] = {.count = 1, .reusable = false}, SHIFT(51),
  [17] = {.count = 1, .reusable = false}, SHIFT(50),
  [19] = {.count = 1, .reusable = true}, SHIFT(170),
  ...
  [29] = {.count = 1, .reusable = true}, SHIFT(81),
  [31] = {.count = 1, .reusable = false}, SHIFT(64),
  [33] = {.count = 1, .reusable = true}, SHIFT(65),
  [35] = {.count = 1, .reusable = false}, SHIFT(66),
  [37] = {.count = 1, .reusable = true}, SHIFT(97),
  ...
  [53] = {.count = 1, .reusable = true}, REDUCE(sym_add, 3),
  [55] = {.count = 1, .reusable = false}, REDUCE(sym_add, 3),
  ...
  [65] = {.count = 1, .reusable = true}, REDUCE(sym_mod, 3),
  [67] = {.count = 1, .reusable = false}, REDUCE(sym_mod, 3),
  [69] = {.count = 1, .reusable = true}, REDUCE(sym_neg, 2),
  [71] = {.count = 1, .reusable = false}, SHIFT(70),
  ...
  [83] = {.count = 1, .reusable = true}, REDUCE(sym_and, 3),
  [85] = {.count = 1, .reusable = true}, REDUCE(sym_or, 3),
  [87] = {.count = 1, .reusable = true}, SHIFT(69),
  [89] = {.count = 1, .reusable = true}, REDUCE(sym_imp, 3),
  [91] = {.count = 1, .reusable = true}, SHIFT(67),
  [93] = {.count = 1, .reusable = true}, SHIFT(68),
  [95] = {.count = 1, .reusable = true}, REDUCE(sym_app, 2),
  [97] = {.count = 1, .reusable = false}, REDUCE(sym_app, 2),
  ...
  [121] = {.count = 1, .reusable = true}, SHIFT(89),
  [123] = {.count = 1, .reusable = true}, SHIFT(85),
  [125] = {.count = 1, .reusable = false}, SHIFT(84),
  [127] = {.count = 1, .reusable = true}, SHIFT(63),
  [129] = {.count = 1, .reusable = false}, SHIFT(82),
  [131] = {.count = 1, .reusable = true}, SHIFT(93),
  [133] = {.count = 1, .reusable = false}, SHIFT(76),
  [135] = {.count = 1, .reusable = true}, SHIFT(96),
  [137] = {.count = 1, .reusable = false}, SHIFT(95),
  ...
  [149] = {.count = 1, .reusable = true}, SHIFT(23),
  [151] = {.count = 1, .reusable = false}, SHIFT(56),
  [153] = {.count = 1, .reusable = true}, SHIFT(181),
  ...
  [163] = {.count = 1, .reusable = true}, REDUCE(sym__expr_list, 2),
  [165] = {.count = 1, .reusable = true}, SHIFT(112),
  [167] = {.count = 1, .reusable = true}, SHIFT(171),
  [169] = {.count = 1, .reusable = true}, SHIFT(169),
  [171] = {.count = 1, .reusable = true}, SHIFT(110),
  [173] = {.count = 1, .reusable = true}, REDUCE(sym__expr_list, 1),
  [175] = {.count = 1, .reusable = true}, SHIFT(111),
  [177] = {.count = 1, .reusable = true}, SHIFT(49),
  [179] = {.count = 1, .reusable = true}, SHIFT(182),
  [181] = {.count = 1, .reusable = true}, SHIFT(94),
  [183] = {.count = 1, .reusable = true}, SHIFT(60),
  ...
  [193] = {.count = 1, .reusable = true}, REDUCE(sym_boolean, 1),
  [195] = {.count = 1, .reusable = false}, REDUCE(sym_boolean, 1),
  [197] = {.count = 1, .reusable = true}, REDUCE(sym__expr, 3),
  [199] = {.count = 1, .reusable = false}, REDUCE(sym__expr, 3),
  [201] = {.count = 1, .reusable = true}, SHIFT(40),
  [203] = {.count = 1, .reusable = true}, SHIFT(27),
  [205] = {.count = 2, .reusable = true}, REDUCE(aux_sym__guarded_command_list_repeat1, 2), SHIFT_REPEAT(92),
  [208] = {.count = 2, .reusable = true}, REDUCE(aux_sym__guarded_command_list_repeat1, 2), SHIFT_REPEAT(97),
  ...
  [217] = {.count = 2, .reusable = true}, REDUCE(aux_sym__guarded_command_list_repeat1, 2), SHIFT_REPEAT(22),
  [220] = {.count = 2, .reusable = false}, REDUCE(aux_sym__guarded_command_list_repeat1, 2), SHIFT_REPEAT(48),
  [223] = {.count = 1, .reusable = true}, SHIFT(33),
  [225] = {.count = 2, .reusable = true}, REDUCE(aux_sym__expr_list_repeat1, 2), SHIFT_REPEAT(92),
  [228] = {.count = 2, .reusable = true}, REDUCE(aux_sym__expr_list_repeat1, 2), SHIFT_REPEAT(97),
  ...
  [237] = {.count = 2, .reusable = true}, REDUCE(aux_sym__expr_list_repeat1, 2), SHIFT_REPEAT(44),
  [240] = {.count = 2, .reusable = false}, REDUCE(aux_sym__expr_list_repeat1, 2), SHIFT_REPEAT(48),
  [243] = {.count = 1, .reusable = true}, SHIFT(21),
  [245] = {.count = 1, .reusable = true}, SHIFT(42),
  [247] = {.count = 1, .reusable = true}, SHIFT(19),
  [249] = {.count = 1, .reusable = true}, SHIFT(5),
  [251] = {.count = 1, .reusable = true}, SHIFT(4),
  [253] = {.count = 1, .reusable = true}, SHIFT(3),
  [255] = {.count = 1, .reusable = true}, SHIFT(11),
  [257] = {.count = 1, .reusable = true}, SHIFT(10),
  [259] = {.count = 1, .reusable = true}, SHIFT(9),
  [261] = {.count = 1, .reusable = true}, SHIFT(13),
  [263] = {.count = 1, .reusable = true}, SHIFT(14),
  [265] = {.count = 1, .reusable = true}, SHIFT(15),
  [267] = {.count = 1, .reusable = true}, SHIFT(16),
  [269] = {.count = 1, .reusable = true}, SHIFT(17),
  [271] = {.count = 1, .reusable = true}, SHIFT(2),
  [273] = {.count = 1, .reusable = true}, SHIFT(34),
  [275] = {.count = 1, .reusable = true}, SHIFT(18),
  [277] = {.count = 1, .reusable = true}, SHIFT(32),
  [279] = {.count = 1, .reusable = true}, SHIFT(45),
  [281] = {.count = 1, .reusable = true}, SHIFT(31),
  [283] = {.count = 1, .reusable = true}, SHIFT(6),
  [285] = {.count = 1, .reusable = true}, SHIFT(30),
  [287] = {.count = 1, .reusable = true}, SHIFT(38),
  [289] = {.count = 1, .reusable = true}, SHIFT(28),
  [291] = {.count = 1, .reusable = true}, SHIFT(25),
  [293] = {.count = 1, .reusable = true}, SHIFT(43),
  [295] = {.count = 1, .reusable = true}, SHIFT(26),
  [297] = {.count = 1, .reusable = true}, SHIFT(7),
  [299] = {.count = 1, .reusable = true}, SHIFT(24),
  [301] = {.count = 1, .reusable = true}, SHIFT(39),
  [303] = {.count = 1, .reusable = true}, SHIFT(37),
  [305] = {.count = 1, .reusable = true}, SHIFT(41),
  [307] = {.count = 1, .reusable = true}, SHIFT(29),
  [309] = {.count = 1, .reusable = true}, SHIFT(20),
  [311] = {.count = 1, .reusable = true}, SHIFT(36),
  [313] = {.count = 1, .reusable = true}, SHIFT(35),
  ...
  [325] = {.count = 2, .reusable = false}, REDUCE(aux_sym_source_file_repeat2, 2), SHIFT_REPEAT(156),
  [328] = {.count = 2, .reusable = false}, REDUCE(aux_sym_source_file_repeat2, 2), SHIFT_REPEAT(87),
  [331] = {.count = 2, .reusable = false}, REDUCE(aux_sym_source_file_repeat2, 2), SHIFT_REPEAT(51),
  [334] = {.count = 2, .reusable = false}, REDUCE(aux_sym_source_file_repeat2, 2), SHIFT_REPEAT(50),
  [337] = {.count = 2, .reusable = true}, REDUCE(aux_sym_source_file_repeat2, 2), SHIFT_REPEAT(170),
  [340] = {.count = 1, .reusable = true}, REDUCE(aux_sym_source_file_repeat2, 2),
  [342] = {.count = 2, .reusable = false}, REDUCE(aux_sym_source_file_repeat2, 2), SHIFT_REPEAT(46),
  [345] = {.count = 2, .reusable = false}, REDUCE(aux_sym_source_file_repeat2, 2), SHIFT_REPEAT(177),
  [348] = {.count = 1, .reusable = false}, REDUCE(aux_sym_source_file_repeat2, 2),
  [350] = {.count = 1, .reusable = false}, SHIFT(177),
  [352] = {.count = 2, .reusable = false}, REDUCE(aux_sym_source_file_repeat2, 2), SHIFT_REPEAT(175),
  [355] = {.count = 1, .reusable = false}, SHIFT(156),
  [357] = {.count = 1, .reusable = true}, SHIFT(173),
  [359] = {.count = 1, .reusable = true}, SHIFT(166),
  [361] = {.count = 2, .reusable = false}, REDUCE(aux_sym_source_file_repeat2, 2), SHIFT_REPEAT(179),
  [364] = {.count = 1, .reusable = true}, REDUCE(sym_source_file, 2),
  [366] = {.count = 1, .reusable = true}, REDUCE(aux_sym_source_file_repeat1, 2),
  [368] = {.count = 2, .reusable = false}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(129),
  [371] = {.count = 2, .reusable = false}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(130),
  ...
  [384] = {.count = 1, .reusable = true}, SHIFT(124),
  [386] = {.count = 1, .reusable = true}, SHIFT(152),
  [388] = {.count = 1, .reusable = true}, SHIFT(142),
  [390] = {.count = 1, .reusable = true}, SHIFT(119),
  [392] = {.count = 1, .reusable = true}, SHIFT(133),
  [394] = {.count = 1, .reusable = true}, SHIFT(143),
  [396] = {.count = 1, .reusable = true}, REDUCE(aux_sym__expr_list_repeat1, 2),
  [398] = {.count = 1, .reusable = false}, REDUCE(aux_sym__expr_list_repeat1, 2),
  [400] = {.count = 1, .reusable = true}, REDUCE(aux_sym__guarded_command_list_repeat1, 2),
  [402] = {.count = 1, .reusable = false}, REDUCE(aux_sym__guarded_command_list_repeat1, 2),
  [404] = {.count = 1, .reusable = true}, SHIFT(47),
  [406] = {.count = 1, .reusable = true}, REDUCE(sym__guarded_command_list, 2),
  [408] = {.count = 1, .reusable = true}, SHIFT(128),
  [410] = {.count = 1, .reusable = true}, SHIFT(86),
  [412] = {.count = 1, .reusable = true}, REDUCE(sym_type_array, 4),
  [414] = {.count = 1, .reusable = false}, REDUCE(sym__variable_list, 2),
  [416] = {.count = 1, .reusable = true}, REDUCE(sym__variable_list, 2),
  [418] = {.count = 1, .reusable = true}, SHIFT(183),
  [420] = {.count = 2, .reusable = true}, REDUCE(aux_sym__variable_list_repeat1, 2), SHIFT_REPEAT(46),
  [423] = {.count = 1, .reusable = true}, SHIFT(127),
  [425] = {.count = 1, .reusable = true}, REDUCE(sym_variable_declaration, 4),
  [427] = {.count = 1, .reusable = true}, REDUCE(sym__type, 3),
  ...
  [437] = {.count = 2, .reusable = true}, REDUCE(aux_sym__constant_list_repeat1, 2), SHIFT_REPEAT(47),
  [440] = {.count = 1, .reusable = true}, REDUCE(sym_type_func, 3),
  [442] = {.count = 1, .reusable = true}, REDUCE(sym_constant_declaration, 4),
  [444] = {.count = 1, .reusable = true}, REDUCE(sym__guarded_command_list, 1),
  [446] = {.count = 1, .reusable = false}, REDUCE(sym__variable_list, 1),
  [448] = {.count = 1, .reusable = true}, REDUCE(sym__variable_list, 1),
  [450] = {.count = 1, .reusable = true}, REDUCE(sym__constant_list, 1),
  [452] = {.count = 1, .reusable = true}, SHIFT(178),
  [454] = {.count = 1, .reusable = true}, REDUCE(sym__constant_list, 2),
  [456] = {.count = 1, .reusable = true}, SHIFT(115),
  [458] = {.count = 1, .reusable = true}, SHIFT(118),
  [460] = {.count = 1, .reusable = true}, SHIFT(62),
  [462] = {.count = 1, .reusable = true},  ACCEPT_INPUT(),
  [464] = {.count = 1, .reusable = true}, SHIFT(114),
  [466] = {.count = 1, .reusable = true}, SHIFT(53),
  [468] = {.count = 1, .reusable = true}, SHIFT(168),
  [470] = {.count = 1, .reusable = true}, REDUCE(sym_assign, 3),
  [472] = {.count = 1, .reusable = true}, REDUCE(sym_spec, 3),
  [474] = {.count = 1, .reusable = true}, REDUCE(sym_do, 3),
  [476] = {.count = 1, .reusable = true}, REDUCE(sym_if, 3),
  [478] = {.count = 1, .reusable = true}, SHIFT(159),
  [480] = {.count = 1, .reusable = true}, SHIFT(106),
  [482] = {.count = 1, .reusable = true}, REDUCE(sym_assert, 3),
  [484] = {.count = 1, .reusable = true}, SHIFT(123),
  [486] = {.count = 1, .reusable = true}, REDUCE(sym_spec, 4),
  [488] = {.count = 1, .reusable = true}, SHIFT(126),
  [490] = {.count = 1, .reusable = true}, SHIFT(117),
  [492] = {.count = 1, .reusable = true}, SHIFT(122),
  [494] = {.count = 1, .reusable = true}, SHIFT(116),
  [496] = {.count = 1, .reusable = true}, REDUCE(aux_sym__constant_list_repeat1, 2),
  [498] = {.count = 1, .reusable = true}, SHIFT(120),
  [500] = {.count = 1, .reusable = true}, SHIFT(167),
  [502] = {.count = 1, .reusable = true}, REDUCE(sym_interval, 5),
  [504] = {.count = 1, .reusable = true}, REDUCE(sym_assert_with_bound, 7),
  [506] = {.count = 1, .reusable = true}, REDUCE(aux_sym__variable_list_repeat1, 2),
};
